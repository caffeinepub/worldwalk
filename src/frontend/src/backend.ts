...
import type { UserProfile as _UserProfile, UserRole as _UserRole, World as _World } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async createWorld(arg0: string, arg1: Array<Building>, arg2: Array<Road>): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.createWorld(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getPlayerPosition(arg0: Principal): Promise<[Pos3D, number, Character]> {
        if (this.processError) {
            try {
                const result = await this.actor.getPlayerPosition(arg0);
                return [
                    result[0],
                    result[1],
                    result[2]
    ...
    async getPlayers(): Promise<Array<[Pos3D, number, Character]>> {
        if (this.processError) {
            try {
    ...
    async getWorld(): Promise<World | null> {
        if (this.processError) {
            try {
                const result = await this.actor.getWorld();
    ...
    async joinWorld(arg0: Character, arg1: Pos3D, arg2: number): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.joinWorld(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async leaveWorld(): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.leaveWorld();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updatePosition(arg0: Pos3D, arg1: number): Promise<void> {
        if (this.processError) {
            try {
...
function from_candid_opt_n6(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_World]): World | null {
    return value.length === 0 ? null : value[0];
}
